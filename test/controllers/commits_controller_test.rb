...
class CommitsControllerTest < ActionController::TestCase
  ...
  test "should create commit" do
    assert_difference('Commit.count') do
      post :create, commit: { message: @commit.message, repo_id: @commit.repo_id, sha: @commit.sha, url: @commit.url }
    end
  ...
  test "should update commit" do
    patch :update, id: @commit, commit: { message: @commit.message, repo_id: @commit.repo_id, sha: @commit.sha, url: @commit.url }
    assert_redirected_to commit_path(assigns(:commit))
  end
